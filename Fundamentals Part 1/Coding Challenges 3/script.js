...
//     console.log('ohh the game ended up with draw!');  
// } else {
...
// if (averageOfDolphins > averageOfKoalas && averageOfDolphins >= minScore) {
//     console.log('Dolphins won');
// } else if (averageOfKoalas === averageOfDolphins) {
//     console.log('ohh the game ended up with draw!');  
// } else if (averageOfDolphins < averageOfKoalas && averageOfKoalas >=  minScore){
//     console.log('Koalas won');
// }
...
// } else if ( averageOfKoalas > averageOfDolphins) {
//     console.log('Koalas won');  
// } else if (averageOfKoalas === averageOfDolphins && averageOfDolphins > minScore && averageOfKoalas > minScore) {
//     console.log('ohh the game ended up with draw!');  
// } else {
